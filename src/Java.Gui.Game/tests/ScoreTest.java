...
class ScoreTest {
    ...
    void testScoreCalculation() {
        ...
        Score score = new Score(1, 6, 2, 1); // 6 first attempts (2 points each), 2 second attempts (1 point each)
    ...
    void testAppendAndRetrieveLargeNumberOfScores() throws IOException {
        ...
        for (int i = 0; i < 25; i++) {
            Score score = new Score(1, i + 1, (i % 3) + 1, (i % 2) + 1);
    ...
    void testCheckForNewHighScore() throws IOException {
        ...
        Score score1 = new Score(1, 6, 2, 1); // 14 points
        Score score2 = new Score(1, 9, 1, 0); // 19 points
        ...
        Score score3 = new Score(1, 7, 2, 1); // 16 points
    ...
    void testNewHighScore() throws IOException {
        ...
        Score score3 = new Score(1, 10, 1, 0); // 21 points
        Score.appendScoreToFile(score3, SCORE_FILE);
    ...
    void testAppendAndCheckMultipleReads() throws IOException {
        ...
        for (int i = 0; i < 5; i++) {
            Score score = new Score(1, 5 + i, 1, 1); // Variable scores
            Score.appendScoreToFile(score, SCORE_FILE);
        }
